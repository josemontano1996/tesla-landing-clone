...
export const Header = () => {
  ...
  return (
    <header>
      <div
        className={`py-3 px-10 flex items-center fixed top-0 w-full justify-between z-40
      ...
      >
        ...
        <nav>
          <ul className='flex [&>li>a]:font-medium [&>li>a]:inline-block [&>li>a]:px-3 [&>li>a]:py-1 [&>li>a]:text-sm'>
        ...
        <nav className='flex justify-end flex-1'>
          <ul className='flex [&>li>a]:inline-block [&>li]:px-2 [&>li]:py-2 [&>li>a]:h-4 [&>li>a]:w-6'>
            <li>
              <a href='#'>
                <svg
